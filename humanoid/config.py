...
class HumanoidConfig:
    ...
    energy_natural_recovery_per_minute: float = 0.9
    energy_natural_recovery_interval_minutes: int = 1
    energy_consumption_per_msg: float = 0.03
    ...
    mood_llm_interval_messages: int = 15
    ...
    social_energy_recovery_per_minute: float = 2.0
